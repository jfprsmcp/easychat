export default {
  ...
  // Chat List
  SET_CONVERSATION_BOARD: 'SET_CONVERSATION_BOARD',
  CLEAR_CONVERSATION_BOARD: 'CLEAR_CONVERSATION_BOARD',
  CLEAR_BOARD_LIST_LOADING_STATUS: 'CLEAR_BOARD_LIST_LOADING_STATUS',
  SET_BOARD_LIST_LOADING_STATUS: 'SET_BOARD_LIST_LOADING_STATUS',
  UPDATE_CONVERSATION_BOARD:'UPDATE_CONVERSATION_BOARD',
  ...
  SET_ALL_MESSAGES_BOARD_LOADED:"SET_ALL_MESSAGES_BOARD_LOADED",
  SET_SUGGESTION_MESSAGE:"SET_SUGGESTION_MESSAGE",
  CLEAR_SUGGESTION_MESSAGE:"CLEAR_SUGGESTION_MESSAGE",
  SET_SELECTED_SUGGESTION_MESSAGE:"SET_SELECTED_SUGGESTION_MESSAGE",
  CLEAR_ALL_MESSAGES_LOADED: 'CLEAR_ALL_MESSAGES_LOADED',
  CLEAR_ALL_MESSAGES_LOADED_BOARD: 'CLEAR_ALL_MESSAGES_LOADED_BOARD',
  ...
  UPDATE_PROPERTIES_CONVERSATION: 'UPDATE_PROPERTIES_CONVERSATION',
  UPDATE_PROPERTIES_CONVERSATION_BOARD: 'UPDATE_PROPERTIES_CONVERSATION_BOARD',
  MOVE_CONVERSATION_BOARD: 'MOVE_CONVERSATION_BOARD',
  ...
  ADD_CONVERSATION_BOARD: 'ADD_CONVERSATION_BOARD',
  UPDATE_CONVERSATION: 'UPDATE_CONVERSATION',
  MUTE_CONVERSATION: 'MUTE_CONVERSATION',
  UNMUTE_CONVERSATION: 'UNMUTE_CONVERSATION',
  ASSIGN_AGENT: 'ASSIGN_AGENT',
  ASSIGN_AGENT_BOARD: 'ASSIGN_AGENT_BOARD',
  ASSIGN_TEAM: 'ASSIGN_TEAM',
  ASSIGN_TEAM_BOARD: 'ASSIGN_TEAM_BOARD',
  ASSIGN_PRIORITY: 'ASSIGN_PRIORITY',
  ASSIGN_PRIORITY_BOARD: 'ASSIGN_PRIORITY_BOARD',
  SET_CHAT_META: 'SET_CHAT_META',
  ADD_MESSAGE: 'ADD_MESSAGE',
  ADD_MESSAGE_BOARD: 'ADD_MESSAGE_BOARD',
  ...
  SET_PREVIOUS_BOARD_CONVERSATIONS:'SET_PREVIOUS_BOARD_CONVERSATIONS',
  ...
  UPDATE_CONVERSATION_BOARD_LAST_ACTIVITY: 'UPDATE_CONVERSATION_BOARD_LAST_ACTIVITY',
  ...
  SET_CONVERSATION_BOARD_CAN_REPLY: 'SET_CONVERSATION_BOARD_CAN_REPLY',
  ...
  SET_CURRENT_PAGE_BOARD: 'SET_CURRENT_PAGE_BOARD',
  SET_CONVERSATION_BOARD_END_REACHED: 'SET_CONVERSATION_BOARD_END_REACHED',
  CLEAR_CURRENT_PAGE_BOARD: 'CLEAR_CURRENT_PAGE_BOARD',
  CLEAR_CONVERSATION_BOARD_END_REACHED: 'CLEAR_CONVERSATION_BOARD_END_REACHED',
  ...
  // Sorter conversation
  SET_SORTER_UI_FLAG: 'SET_SORTER_UI_FLAG',
  SET_SORTERS: 'SET_SORTERS',
  ADD_SORTER: 'ADD_SORTER',
  EDIT_SORTER: 'EDIT_SORTER',
  DELETE_SORTER: 'DELETE_SORTER',

  // kanban state conversation
  SET_KANBAN_STATE_UI_FLAG: 'SET_KANBAN_STATE_UI_FLAG',
  SET_KANBAN_STATES: 'SET_KANBAN_STATES',
  ADD_KANBAN_STATE: 'ADD_KANBAN_STATE',
  EDIT_KANBAN_STATE: 'EDIT_KANBAN_STATE',
  DELETE_KANBAN_STATE: 'DELETE_KANBAN_STATE',
  UPDATE_COUNT_KANBAN_STATE: 'UPDATE_COUNT_KANBAN_STATE'
};
