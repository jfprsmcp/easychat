...
const isOpen = computed(
  () => props.currentChat.status === wootConstants.STATUS_TYPE.OPEN
);
const isPending = computed(
  () => props.currentChat.status === wootConstants.STATUS_TYPE.PENDING
);
const isResolved = computed(
  () => props.currentChat.status === wootConstants.STATUS_TYPE.RESOLVED
);
const isSnoozed = computed(
  () => props.currentChat.status === wootConstants.STATUS_TYPE.SNOOZED
);
