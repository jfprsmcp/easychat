...
import ContactBoardPanel from 'dashboard/routes/dashboard/conversation/ContactBoardPanel.vue';
import ConversationBoardHeader from './ConversationBoardHeader.vue';
import DashboardAppFrame from '../DashboardApp/Frame.vue';
import EmptyBoardState from './EmptyState/EmptyBoardState.vue';
import MessagesBoardView from './MessagesBoardView.vue';

export default {
  components: {
    ContactBoardPanel,
    ConversationBoardHeader,
    DashboardAppFrame,
    EmptyBoardState,
    MessagesBoardView,
  },
